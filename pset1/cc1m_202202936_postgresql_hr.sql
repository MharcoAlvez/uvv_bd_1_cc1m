...
/* Logando na Database com o Usuário marco */
\c uvv marco;
202202936

/* Criando SCHEMA hr */
CREATE SCHEMA hr AUTHORIZATION marco;

/* Botando o SCHEMA hr como padrão */
ALTER USER marco
SET SEARCH_PATH TO hr, "$user", public;
show search_path;

/* PARA CRIAR AS TABELAS, LEMBRAR DE EXUCEUTAR SEPARADO */
...
COMMENT ON TABLE hr.cargos IS 'Tabela cargos, que armazena os cargos existentes para cada cargo.';
COMMENT ON COLUMN hr.cargos.id_cargo IS 'Chave primária';
COMMENT ON COLUMN hr.cargos.cargo IS 'Nome do cargo.';
COMMENT ON COLUMN hr.cargos.salario_minimo IS 'O menor salário';
COMMENT ON COLUMN hr.cargos.salario_maximo IS 'O maior salário';


/* PARA CRIAR A TABELA DE REGIAO */
...
COMMENT ON TABLE hr.paises IS 'Tabela com as informaçõs';
COMMENT ON COLUMN hr.paises.id_pais IS 'Chave primária';
COMMENT ON COLUMN hr.paises.nome IS 'Nome do país.';
COMMENT ON COLUMN hr.paises.id_regiao IS 'Chave estrangeira.';
...
/* PARA CRIAR A TABELA DE LOCALIZAÇÃO */
...
COMMENT ON TABLE hr.localizacoes IS 'Tabela localizaçõs.';
COMMENT ON COLUMN hr.localizacoes.id_localizacao IS 'Chave primária.';
COMMENT ON COLUMN hr.localizacoes.endereco IS 'da empresa.';
COMMENT ON COLUMN hr.localizacoes.cep IS '.';
COMMENT ON COLUMN hr.localizacoes.cidade IS 'da empresa.';
COMMENT ON COLUMN hr.localizacoes.uf IS 'ritório ou outra
facilidade da empresa.';
COMMENT ON COLUMN hr.localizacoes.id_pais IS 'Chave estrangeira.';


/* PARA CRIAR A TABELA DE DEPARTAMENTOS */
...
COMMENT ON TABLE hr.departamentos IS 'Tabela com as informações sobre os departamentos da empresa.';
...
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'qual empregado,
...
COMMENT ON COLUMN hr.empregados.telefone IS 'ado)';
...
COMMENT ON COLUMN hr.empregados.comissao IS 'o departamento
de vendas são elegíveis para comissões.';
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'Chave primária da tabela.';
COMMENT ON COLUMN hr.empregados.id_departamento IS 'epartamento atual
de um empregado.';
...
/* PARA CRIAR A TABELA DE GERENTES */
CREATE TABLE hr.gerentes (
                id_departamento INTEGER NOT NULL,
                id_empregado INTEGER,
                CONSTRAINT gerentes_pk PRIMARY KEY (id_departamento, id_empregado)
);
COMMENT ON COLUMN hr.gerentes.id_departamento IS 'Chave primária';
COMMENT ON COLUMN hr.gerentes.id_empregado IS 'Chave primária';


/* PARA CRIAR A TABELA DE HISTORICO DE CARGOS */
CREATE TABLE hr.historico_cargos (
                ...
                id_cargo VARCHAR(10) NOT NULL,
                id_departamento INTEGER NOT NULL,
                CONSTRAINT id_data_inicial PRIMARY KEY (id_empregado, data_inicial)
);
...
antiga do empregado.';
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'mpregados.';
COMMENT ON COLUMN hr.historico_cargos.data_inicial IS 'cargo. Deve ser menor do que a
data_final.';
COMMENT ON COLUMN hr.historico_cargos.data_final IS 'data inicial.';
COMMENT ON COLUMN hr.historico_cargos.id_cargo IS 'Chave primária.';
COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'assado.';
...
/* INSRINDO OS GERENTES */
INSERT INTO gerentes (id_departamento, id_empregado ) VALUES
(110, 205);
INSERT INTO gerentes (id_departamento, id_empregado) VALUES
(70, 204);
INSERT INTO gerentes (id_departamento, id_empregado) VALUES
...
/* INSERINDO O HISTORICO DE CARGOS */
